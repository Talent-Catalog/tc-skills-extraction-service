# tc-skills-extraction OPC Production Environment

Deploy the tc-skills-extraction infrastructure to the OPC AWS production account (`289896345557`, `eu-west-2`).
...
```bash
cd infra/terraform/tc-skills-service-opc-prod
terraform init
```
